...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    description: "创建个体经营，抖音电商自运营小店，撸空投，Web3 Dapp开发，运营开发基于Lens的去中心化社交平台（已停止维护）",
    category: "work",
    portfolioImages: [
    ...
    link: { url: "https://github.com/qinjiangban/Archive-coolha.com/tree/main", label: "github.com/qinjiangban/Archive-coolha.com" },
  },
  {
    id: "nft-intern",
    role: "数字资产专员",
    ...
    locationType: "现场办公",
    description:
      "电商数据用户消费行为画像打包成NFT售卖，DAPP产品交互，为企业提供Web3区块链行业研究。\n辅助学习电商运营。",
    category: "work",
  },
  {
